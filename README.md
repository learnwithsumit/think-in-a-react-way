...
<br />
<p align="center">
  <h3 align="center"><a href="https://github.com/learnwithsumit/think-in-a-react-way">React Router Version 6 - Think in a React way Tutorial Series [ in Bangla ]</a></h3>
...
This is the example project built with react-router 6 shown in Lesson 45.
...
1. Clone this repository
   ...
   ```
2. Checkout to branch "lesson-45"
   ```sh
   git checkout lesson-45
   ```
